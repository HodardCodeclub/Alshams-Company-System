...
<form method="post" action="../../common_assets/DB_Commands/startPoint.php">
 <div class="form-group">
   ...
   <option value="2">Credit</option>
    ...
    Subcontractor Name: <input  size="100" name="subname" id="skills" class="form-control" required="">
     </div>
   
  

    <button type="submit" class="btn btn-default" name="createaccountSub"  >create account</button>
